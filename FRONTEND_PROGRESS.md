...
### ✅ Módulo 15 — Contabilidad Admin (COMPLETO)

- [x] `src/pages/admin/Accounting.jsx` — resumen financiero por mes/año
- [x] Cards: ingresos, gastos, balance (superávit/déficit)
- [x] Tab Ingresos: detalle de pagos aprobados del mes
- [x] Tab Gastos: lista de gastos con categorías y facturas
- [x] Resumen por categoría de gastos
- [x] Botón imprimir para reportes físicos
- [x] Ruta /admin/contabilidad en App.jsx
- [x] Link Contabilidad en Sidebar admin
...
backend/
├── controllers/
│   ├── authController.js ✅ (register actualiza apartamento, getUsuarios añadido)
...
│   ├── incidentController.js ✅ (getMisIncidencias añadido)
│   ├── fineController.js ✅
...
├── middleware/
│   ├── auth.js ✅
│   └── upload.js ✅ (resource_type auto para PDFs)
├── models/ ✅ (todos sin cambios)
├── routes/
│   ├── authRoutes.js ✅ (GET /usuarios añadido)
│   ├── incidentRoutes.js ✅ (GET /mis-incidencias añadido)
│   └── resto sin cambios ✅
└── server.js ✅
```
